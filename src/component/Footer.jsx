...
const Footer = () => {
    ...
    return (
        <div className=" block bottom-0 bg-purple-600 bg-gradient-to-l  from-yellow-400 background-animate">
            <div class=" shadow-zinc-800 shadow-[0_-25px_50px_-12px_rgba(0,0,0,0.25)]  sha bg-zinc-800 text-slate-200 relative flex overflow-x-hidden">
            ...
            <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <p class="mt-8 text-base leading-6 text-center text-gray-200">
                    © 2021 Blizard, Inc. All rights reserved.
                </p>
            </div>
        </div>
    );
